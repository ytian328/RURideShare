...
<%
	...
	String sql = "select r.dep, r.des, r.date, r.timef, r.timet, o.timef, o.timet, o.did, m.status, m.mid, m.revstat, u.email2, c.* "
			+ "from requests r, offers o, matches m, users u, cars c "
			+ "where (m.status='CNL' or m.status='FNS' or m.status='EXP') and r.pid=? and m.rid=r.rid and m.oid=o.oid and o.did=u.uid and c.plate=o.plate ";
